...
ss_dfm.makestates(t=smooth, n=smooth_states) e_dl_rgdp e_dl_retail_sales e_dl_pmi_manu_new e_dl_im s1 

'' Graph state variable
graph dfm_states_line.line(n) dl_rgdp dl_retail_sales dl_pmi_manu_new dl_im s1

'' Generate nowcast 
''' YoY growth rate nowcast from DFM
series dl_rgdp_sspace = c(1)*s1 + e_dl_rgdp + @mean(dl_rgdp, "2011q3 2022q4")
